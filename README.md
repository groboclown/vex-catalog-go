...
* A cache implementation.  Out of the box, you can use the [`cache.None`](vexcatalog/cache/none.go) to skip caching, or [`cache.NewMemoryCache()`](vexcatalog/cache/mem_cache.go).  Future versions may provide additional implementations.
